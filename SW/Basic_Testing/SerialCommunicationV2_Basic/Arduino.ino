...
void loop() {    
  ...
  if(Serial.available() > 0 && !ESP8266_superSlowCode_isExecuting){ 
    char rc = Serial.read(); // lettura di '$', che dice che c'è super slow part che sta per eseguire
    ESP8266_superSlowCode_isExecuting = true;
  }
